...
namespace Logiciel_fdm
{
    ...
    public class GestionExcel
    {
        ...
        public Range _MonRange; // le range est une zone selectionnée de façon virtuelle ou les calculs s'effectuent. Range est cellule active sont deux chose differentes. 
        ...
        ///<summary>
        ///Insère une image dans un Excel à partir des coordonnées en points et de la taille en points de l'image
        /// </summary>
        /// <param name="Gauche">Position en points du coin haut-gauche de l'image par rapport à la 1ère cellule de l'Excel </param>
        /// <param name="Haut">Même chose </param>
        /// <param name="Largeur">Largeur de l'image en points</param>
        /// <param name="Hauteur">Hauteur de l'image en points </param>
        /// <param name="path">Chemin d'accès de l'image</param>
        public void InsererImage(float Gauche, float Haut, float Largeur, float Hauteur, string path)
        {
            _MaFeuille.Shapes.AddPicture(path, Microsoft.Office.Core.MsoTriState.msoFalse,
                Microsoft.Office.Core.MsoTriState.msoCTrue, Gauche, Haut, Largeur, Hauteur);
        }
