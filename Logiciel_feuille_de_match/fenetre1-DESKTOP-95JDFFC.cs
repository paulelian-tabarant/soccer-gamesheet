...
namespace Logiciel_fdm
{
    public partial class fenetre1 : Form
    {
        ...
        private void help_Click(object sender, EventArgs e)
        {
            ...
            string aide_complement = "Il est à noter que pour déverrouiller le bouton ''Confirmer'' et ainsi passer à la fenêtre suivante, tous ces champs doivent être renseignés. Les détails sur la compositions des équipes sont à remplir dans la prochaine fenêtre";
            string aide = aide_présentation + aide_liste + aide_complement;
            MessageBox.Show(aide, "Aide");
        }

        private void nom_arbitre_prinicpal_TextChanged(object sender, EventArgs e)
        {
